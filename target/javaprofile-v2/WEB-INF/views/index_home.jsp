                ...
                <div class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="${contextPath}/index">DHANVEER AHAMED</a>
                            <i class="brand_network"><small><small>JavaProfile</small></small></i>
                        </div>
...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="container w3-padding-32" id="about">
    ...
    <div class="w3-content" style="max-width:700px">
	    <p style="text-align:justify;">I have 15+ years diverse experience in IT Infrastructure Management, DevOps, Private/Public Cloud Solutions. Excellent knowledge and rich hands-on experience in Planning, Designing, Implementation, Migration, Capacity Planning, Upgradation and Maintenance of Server and Application Virtualization, Server Consolidation, Cloud Solutions, CI/CD Pipeline Configuration, Server Management and Administration.
	    </p>
	    <p><strong>Address:</strong>  Dubai</p> 
	    <p><strong>Ph No: </strong>  +971-563548061</p>
		<p><strong>E-Mail ID :</strong>  dhanveerahamed@gmail.com</p>
  	</div>
   </div>
...
<footer class="w3-center  w3-padding-16" style="background-color:#1C3B47 ">
  <p style="color:#FFFFFF ">Copyright @2024 <a href="#"  target="_blank" class="w3-hover-text-green"> dhanveerit.com</a></p>
</footer>
