    ...
    <div class="row">
                ...
                <div class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#">DA Infotech</a>
                            <i class="brand_network"><small><small>DA* Network</small></small></i>
                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        <p class="text-muted small">
                                                            ${pageContext.request.userPrincipal.name}@dhanveerit.co.in</p>
                                                        <div class="divider">
                                                        </div>
                ...
                <div class="panel-body">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>DevOps For Product Management and Strategy of Application Delivery at DA Infotech. Responsible of providing customers with counsel on their DevOps strategies to help them deliver higher quality software and services to market faster.</p>
                            <hr>
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <span>
                        <h1 class="panel-title pull-left" style="font-size:30px;">${pageContext.request.userPrincipal.name} &nbsp; <small>${pageContext.request.userPrincipal.name}@dhanveerit.co.in</small> <i class="fa fa-check text-success" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title=" sharing with you"></i></h1>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <hr>
                    <div class="post-content">
                        <p>"Feeling Happy to be a Full Stack Developer and a DevOps Engineer."</p>
                    </div>
                    <hr>
                    <div>
                        <div class="pull-right btn-group-xs">
                        ...
                        <div class="post-content">
                            <div class="panel-default">
                                <div class="panel-body">
                                    ...
                                    <hr>
                                    <div class="post-content">
                                        <p>Full Stack Development and DevOps has significant importance to any company delivering software or technical services today.Defining the scope is trickier than you would think, primarily because of its wide usage. It is essentially shorthand, and nothing more than that, for a lean approach to software delivery.</p>
